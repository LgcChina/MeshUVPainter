...
public sealed class EditorLanguageManager
{
    ...
    public void InitLanguageData()
    {
        ...
        _zh["BottomAuthorInfo"] = "作者：copilote + qianwen + LGC";
        _ja["BottomAuthorInfo"] = "作者：copilote + qianwen + LGC";
        _en["BottomAuthorInfo"] = "Author: copilote + qianwen + LGC";
        ...
        _zh["AuthorName"] = "作者：copilote + qianwen + LGC";
        _ja["AuthorName"] = "作者：copilote + qianwen + LGC";
        _en["AuthorName"] = "Author: copilote + qianwen + LGC";
